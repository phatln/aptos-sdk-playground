import { Aptos, AptosConfig, Network, Account, Ed25519PrivateKey, Deserializer, generateTransactionPayload, generateRawTransaction, SimpleTransaction, MoveVector, HexInput, AccountAddress, Serializer } from "@aptos-labs/ts-sdk";
...
export const objectCodeUpgrade = async () => {
  ...
  serializer.serializeU8(OP_CODE);
  serializer.serializeU64(POS_ID);
  console.log(serializer.toUint8Array());
